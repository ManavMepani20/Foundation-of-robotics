...
my_service_package__msg__VelPos__init(my_service_package__msg__VelPos * msg)
{
  ...
  if (!geometry_msgs__msg__Twist__init(&msg->twist)) {
    my_service_package__msg__VelPos__fini(msg);
    return false;
  }
  // pos
...
my_service_package__msg__VelPos__create()
{
  ...
  my_service_package__msg__VelPos * msg = (my_service_package__msg__VelPos *)allocator.allocate(sizeof(my_service_package__msg__VelPos), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(my_service_package__msg__VelPos));
  bool success = my_service_package__msg__VelPos__init(msg);
  if (!success) {
...
my_service_package__msg__VelPos__Sequence__init(my_service_package__msg__VelPos__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_service_package__msg__VelPos * data = NULL;

  if (size) {
    data = (my_service_package__msg__VelPos *)allocator.zero_allocate(size, sizeof(my_service_package__msg__VelPos), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = my_service_package__msg__VelPos__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        my_service_package__msg__VelPos__fini(&data[i - 1]);
      }
...
my_service_package__msg__VelPos__Sequence__fini(my_service_package__msg__VelPos__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      my_service_package__msg__VelPos__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_service_package__msg__VelPos__Sequence * array = (my_service_package__msg__VelPos__Sequence *)allocator.allocate(sizeof(my_service_package__msg__VelPos__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = my_service_package__msg__VelPos__Sequence__init(array, size);
  if (!success) {
...
my_service_package__msg__VelPos__Sequence__destroy(my_service_package__msg__VelPos__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    my_service_package__msg__VelPos__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
my_service_package__msg__VelPos__Sequence__are_equal(const my_service_package__msg__VelPos__Sequence * lhs, const my_service_package__msg__VelPos__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!my_service_package__msg__VelPos__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  my_service_package__msg__VelPos__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(my_service_package__msg__VelPos);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    my_service_package__msg__VelPos * data =
      (my_service_package__msg__VelPos *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!my_service_package__msg__VelPos__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          my_service_package__msg__VelPos__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!my_service_package__msg__VelPos__copy(
