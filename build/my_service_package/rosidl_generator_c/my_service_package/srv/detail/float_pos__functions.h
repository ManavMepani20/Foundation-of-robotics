...
#ifndef MY_SERVICE_PACKAGE__SRV__DETAIL__FLOAT_POS__FUNCTIONS_H_
#define MY_SERVICE_PACKAGE__SRV__DETAIL__FLOAT_POS__FUNCTIONS_H_
...
/// Initialize srv/FloatPos message.
/**
...
/// Create srv/FloatPos message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * my_service_package__srv__FloatPos_Request__init().
...
/// Destroy srv/FloatPos message.
/**
 * It calls
 * my_service_package__srv__FloatPos_Request__fini()
...
/// Check for srv/FloatPos message equality.
/**
...
/// Initialize array of srv/FloatPos messages.
/**
...
/// Finalize array of srv/FloatPos messages.
/**
 * It calls
 * my_service_package__srv__FloatPos_Request__fini()
...
/// Create array of srv/FloatPos messages.
/**
 * It allocates the memory for the array and calls
 * my_service_package__srv__FloatPos_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/FloatPos messages.
/**
 * It calls
 * my_service_package__srv__FloatPos_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/FloatPos message array equality.
/**
...
/// Copy an array of srv/FloatPos messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * my_service_package__srv__FloatPos_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_my_service_package
...
/**
 * It calls
 * my_service_package__srv__FloatPos_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_my_service_package
...
/**
 * It allocates the memory for the array and calls
 * my_service_package__srv__FloatPos_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_my_service_package
...
/**
 * It calls
 * my_service_package__srv__FloatPos_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // MY_SERVICE_PACKAGE__SRV__DETAIL__FLOAT_POS__FUNCTIONS_H_
