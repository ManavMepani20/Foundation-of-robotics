...
bool my_service_package__msg__vel_pos__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("my_service_package.msg._vel_pos.VelPos", full_classname_dest, 38) == 0);
  }
  my_service_package__msg__VelPos * ros_message = _ros_message;
  {  // twist
  ...
  {  // pos
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      double * dest = ros_message->pos.data;
...
{
  /* NOTE(esteve): Call constructor of VelPos */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("my_service_package.msg._vel_pos");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "VelPos");
  ...
  {  // pos
    ...
    if (ros_message->pos.size > 0) {
      ...
      double * src = &(ros_message->pos.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->pos.size * sizeof(double));
      assert(data != NULL);
