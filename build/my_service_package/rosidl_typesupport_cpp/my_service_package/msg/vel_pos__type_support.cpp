...
static const _VelPos_type_support_symbol_names_t _VelPos_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_service_package, msg, VelPos)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, my_service_package, msg, VelPos)),
  }
};
...
{
  return &::my_service_package::msg::rosidl_typesupport_cpp::VelPos_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, my_service_package, msg, VelPos)() {
  return get_message_type_support_handle<my_service_package::msg::VelPos>();
}
