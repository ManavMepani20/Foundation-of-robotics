...
static const _IKservice_Request_type_support_symbol_names_t _IKservice_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_service_package, srv, IKservice_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, my_service_package, srv, IKservice_Request)),
  }
};
...
{
  return &::my_service_package::srv::rosidl_typesupport_cpp::IKservice_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, my_service_package, srv, IKservice_Request)() {
  return get_message_type_support_handle<my_service_package::srv::IKservice_Request>();
}
...
static const _IKservice_Response_type_support_symbol_names_t _IKservice_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_service_package, srv, IKservice_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, my_service_package, srv, IKservice_Response)),
  }
};
...
{
  return &::my_service_package::srv::rosidl_typesupport_cpp::IKservice_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, my_service_package, srv, IKservice_Response)() {
  return get_message_type_support_handle<my_service_package::srv::IKservice_Response>();
}
...
static const _IKservice_type_support_symbol_names_t _IKservice_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_service_package, srv, IKservice)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, my_service_package, srv, IKservice)),
  }
};
...
{
  return &::my_service_package::srv::rosidl_typesupport_cpp::IKservice_service_type_support_handle;
}
