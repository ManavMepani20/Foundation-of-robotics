...
bool my_service_package__srv__i_kservice__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("my_service_package.srv._i_kservice.IKservice_Request", full_classname_dest, 52) == 0);
  }
  my_service_package__srv__IKservice_Request * ros_message = _ros_message;
  {  // position
    ...
    geometry_msgs__msg__Point * dest = ros_message->position.data;
  ...
  {  // orientation
    ...
    if (!geometry_msgs__msg__Quaternion__Sequence__init(&(ros_message->orientation), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create geometry_msgs__msg__Quaternion__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    geometry_msgs__msg__Quaternion * dest = ros_message->orientation.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!geometry_msgs__msg__quaternion__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
  ...
  {  // claw
    PyObject * field = PyObject_GetAttrString(_pymsg, "claw");
    if (!field) {
      return false;
    }
    if (PyObject_CheckBuffer(field)) {
      ...
      double * dest = ros_message->claw.data;
      ...
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'claw'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
...
PyObject * my_service_package__srv__i_kservice__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("my_service_package.srv._i_kservice");
  ...
  {  // orientation
    ...
    for (size_t i = 0; i < size; ++i) {
      item = &(ros_message->orientation.data[i]);
      PyObject * pyitem = geometry_msgs__msg__quaternion__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
  ...
  {  // claw
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "claw");
    if (!field) {
      return NULL;
    }
    ...
    if (ros_message->claw.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      double * src = &(ros_message->claw.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->claw.size * sizeof(double));
      assert(data != NULL);
...
ROSIDL_GENERATOR_C_EXPORT
bool my_service_package__srv__i_kservice__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("my_service_package.srv._i_kservice.IKservice_Response", full_classname_dest, 53) == 0);
  }
  my_service_package__srv__IKservice_Response * ros_message = _ros_message;
  {  // joint_positions
